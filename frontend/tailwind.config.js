  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        // Luxury shadows
        'luxury': '0 1px 3px rgba(0, 0, 0, 0.05), 0 4px 12px rgba(139, 92, 246, 0.08), 0 8px 24px rgba(139, 92, 246, 0.04)',
        'luxury-hover': '0 4px 6px rgba(0, 0, 0, 0.07), 0 12px 24px rgba(139, 92, 246, 0.15), 0 24px 48px rgba(139, 92, 246, 0.1)',
      },
      animation: {
